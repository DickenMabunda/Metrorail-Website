...
const ptaList = [
  { title: "Pretoria - Pinnarsport", id: 1 },
  { title: "Pretoria - Mamelodi Gardens", id: 2 },
  { title: "Pretoria - Mabopane", id: 3 },
  { title: "Pretoria - Saulsville", id: 4 },
  { title: "Pretoria - De Wildt", id: 5 },
];
...
const Pretoria = () => {
  ...
  const handleNumbersThree = () => {
   ...
   const handleNumbersFour = () => {

    // I have to fix this

    if(numbers < TimetablesTwo.length) {
  ...
  return (
    <>
      {two ? (
        <div className="pretoria">
          <div className="pretoria-route">
            <img className="img-4" src="/img-2.jpeg"></img>
            <h1 className="text-4">Pretoria Routes</h1>
          </div>
          <div className="pretoria-list">
            {ptaList.map((list) => (
              <div className="inner-list" key={list.id}>
                <li
      ...
      {/* SECOND DIV TO STORE TIMETABLES */}
            ...
            <>
              <div className="timetables">
                <>
                  <div className="route-major">
                    ...
                    <div className="button-area">
                      ...
                      <button className="button2" onClick={handleNumbersFour}>
                        Show More
                      </button>
                      <button className="button2" onClick={handleNumbersThree}>
                        Return back
                      </button>
                    </div>
                  </div>
                ...
                <div className="route-major-2">
                  <div>
                    <div className="edit-major">
                      {TimetablesTwo[numbers][0].map((stats) => (
                        <div className="edit" key={stats.id}>
                          <div>
                            <h1 className="from">{stats.from}</h1>
                          </div>
                  ...
                  <div className="edit-major">
                    {TimetablesTwo[numbers][1].map((stats) => (
                      <div className="edit">
                        <div>
                          <h1 className="from">{stats.from}</h1>
                        </div>
